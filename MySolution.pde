...
//        int firstp = os.partitionTable.indexOf(partition);
//        if(os.partitionTable.get(firstp).size>os.partitionTable.get(i).size){
//          PartitionInfo best = os.partitionTable.get(i);
//          if(best.size>=requestedSize){
//            partition = os.partitionTable.get(i);
//          }
//        }
//      }
